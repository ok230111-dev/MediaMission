...
const ISSUE_TYPES = {
  ...
  theory: ["wont_open", "content_not_loading", "missing_content", "broken_resource_link", "other"],
...
const ISSUE_LABELS = {
  ...
  content_not_loading: body.dataset.tIssueContentNotLoading,
  missing_content: body.dataset.tIssueMissingContent,
  broken_resource_link: body.dataset.tIssueBrokenResourceLink,
